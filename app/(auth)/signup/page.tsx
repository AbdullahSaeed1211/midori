    ...
    return (
      <div className="min-h-screen bg-charcoal-black relative overflow-hidden flex items-center justify-center px-4">
        ...
        <div className="relative max-w-md w-full text-center">
          ...
          <p className="text-off-white/60 mb-6">We sent a confirmation link to<br /><span className="text-kiiro-yellow">{email}</span></p>
          <p className="text-sm text-off-white/40">Click the link in the email to activate your account</p>
          <Link href="/login" className="mt-8 inline-flex items-center gap-2 text-kiiro-yellow hover:underline">
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-off-white mt-6 mb-2">Create your account</h1>
            <p className="text-off-white/60">Get started with your client portal</p>
          </div>
          ...
          <div className="bg-charcoal-gray/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <form action={handleSignup} className="space-y-5">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-off-white mb-2">Full name</label>
                <input
                  id="name"
                  name="name"
                  type="text"
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-off-white mb-2">Password</label>
                <input
                  id="password"
                  name="password"
                  type="password"
                  ...
                  placeholder="••••••••"
                />
                <p className="text-xs text-off-white/40 mt-1">Must be at least 6 characters</p>
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-off-white/10">
              <p className="text-center text-off-white/60 text-sm">
                ...
                <Link href="/login" className="text-kiiro-yellow hover:text-kiiro-yellow/80 font-medium transition-colors">
                  Sign in
                </Link>
              </p>
            </div>
